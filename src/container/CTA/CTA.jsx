...
const CTA = () => {
  return (
    <div>
      <div className="py-12 px-52 flex justify-start items-center border-b">
        <h2 className="text-7xl font-semibold font-montserrat">
          DESIGN DREAMS
        </h2>
      </div>
      <div className="py-12 pr-52 flex justify-center items-center border-b">
        <h2 className="text-portfolio text-7xl font-semibold font-montserrat">
          INTO REALITY?
        </h2>
      </div>
      <div className="py-12 px-52 flex justify-end items-center border-b">
