...
export { default as FadeContent } from './animations/FadeContent';
export { default as MagicBento } from './animations/MagicBento';

export { default as Squares } from './backgrounds/Squares';